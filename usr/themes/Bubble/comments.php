									...
									<div class="input-group mb-4">
										<div class="input-group-prepend">
											<span class="input-group-text" style="padding: 0rem .5rem;">
            									<div id="author-head" class="icon-shape rounded-circle text-white" style="width: 2rem;height: 2rem;background-image: url(https://rbtree.app/avatar.png);background-position: center;background-size: cover;background-repeat: no-repeat;"></div>
            								</span>
										</div>
...
<script>
	...
	$("#mail").on('blur',function(){
    	url = "https://rbtree.app/avatar.png"
